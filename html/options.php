<div class='wrap amazonfeedadmin'>
	...
	<h2>Amazon Feed: Options</h2>
	
	<ul id="tabnav">
		<li><a href="<?php echo $homePath; ?>&amazonFeedAdminPage=dashboard">Dashboard</a></li>
		<li><a href="<?php echo $homePath; ?>&amazonFeedAdminPage=options" class='highlighted'>Options</a></li>
	...
	<ul class='secondTabs'>
		<li><a href="javascript:;" onClick="jQuery('#amazonFeedConnection').show(); jQuery('#amazonFeedSearch').hide(); jQuery('#amazonFeedDisplay').hide(); jQuery('.updated').hide();">Connection</a></li>
		<li><a href="javascript:;" onClick="jQuery('#amazonFeedConnection').hide(); jQuery('#amazonFeedSearch').show(); jQuery('#amazonFeedDisplay').hide(); jQuery('.updated').hide();">Search</a></li>
		<li><a href="javascript:;" onClick="jQuery('#amazonFeedConnection').hide(); jQuery('#amazonFeedSearch').hide(); jQuery('#amazonFeedDisplay').show(); jQuery('.updated').hide();">Display</a></li>
	</ul>
	
	<form action='<?php echo $homePath; ?>&amazonFeedAdminPage=options' method='POST'>
		<div id="amazonFeedConnection">
			<table class='widefat' style='width: 600px;'>
				...
				<tr>
					...
					<td><input type='password' name='AWSSecretAccessKeyId' value='<?php if(isset($this->options['AWSSecretAccessKeyId']) AND $this->options['AWSSecretAccessKeyId']) echo "************************"; ?>' /></td>
				</tr>
				<tr>
		...
		<div id="amazonFeedSearch" style='display:none;'>
			<table class='widefat' style='width: 600px;'>
				<tr>
		...
		<div id="amazonFeedDisplay" style='display:none;'>
			<table class='widefat' style='width: 600px;'>
				<tr>
				...
				<tr>
					<td><strong>Display StyleSheet:</strong><br/><small>Choose a stylesheet for use in displaying the products on your blog.  You can also create your own and put them in the amazonfeed/css/ folder.</small></td>
