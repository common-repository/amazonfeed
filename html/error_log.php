<div class='wrap amazonfeedadmin'>
	...
	<ul id="tabnav">
		...
		<li><a href="<?php echo $homePath; ?>&amazonFeedAdminPage=message_log" class='highlighted'>Message Log</a></li>
	...
	<ul class='secondTabs'>
		<li><a href="<?php echo $homePath; ?>&amazonFeedAdminPage=message_log">Refresh Log</a></li>
		<li><a href="<?php echo $homePath; ?>&amazonFeedAdminPage=message_log&clear_log=true" onClick="return(confirm('Are you sure you want to clear the message log?'));">Clear Message Log</a></li>
	</ul>
